    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="relative h-[500px] rounded-xl overflow-hidden mb-12">
        <div className="absolute inset-0 w-full h-full">
          ...
          >
            <source
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/11957140_1920_1080_60fps-mqz6omTWaVjuS0YYRmpeCAwUn7TNey.mp4"
              type="video/mp4"
            />
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-black/30 flex flex-col justify-center px-8 md:px-16">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button size="lg" className="bg-white text-green-600 hover:bg-gray-100 font-medium" asChild>
              <Link href="/contact">
            ...
            >
              ...
              >
                {service.type === "whatsapp" ? (
                  <a
                    href={`https://api.whatsapp.com/send/?phone=13083891551&text=${encodeURIComponent(service.whatsappText ?? "")}&type=phone_number&app_absent=0`}
                    target="_blank"
